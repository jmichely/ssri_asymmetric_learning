...
%%%
[running_out_current_day1_pos, running_out_current_day1_neg, running_out_current_day2_pos, running_out_current_day2_neg] = running_out(A, B, comp_num_day1, comp_num_day2, subj);

%%%
regression_matrix_day1=[choice_day1_positive,deck_day1_norm,comp_num_day1_norm,running_out_current_day1_pos,running_out_current_day1_neg];
regression_matrix_day2=[choice_day2_positive,deck_day2_norm,comp_num_day2_norm,running_out_current_day2_pos,running_out_current_day2_neg];

%
i=1;
for k=0:number_of_trials:length(choice_day1)-number_of_trials %logistic regression for each subject (every 180 trials)
    %
    coefficients_per_subj_day1_all_run_out2(i,1:5)=mnrfit(regression_matrix_day1(k+1:k+number_of_trials,2:5),regression_matrix_day1(k+1:k+number_of_trials,1));
    %
    i=i+1;
end
...
for k=0:number_of_trials:length(choice_day2)-number_of_trials %logistic regression for each subject (every 180 trials) 
    %
    coefficients_per_subj_day2_all_run_out2(i,1:5)=mnrfit(regression_matrix_day2(k+1:k+number_of_trials,2:5),regression_matrix_day2(k+1:k+number_of_trials,1));
    %
    i=i+1;
end
...
%
results.log_reg.day1.all_run_out2 = coefficients_per_subj_day1_all_run_out2; %%% run_out2 = sum of running outcomes (pos/neg)
results.log_reg.day2.all_run_out2 = coefficients_per_subj_day2_all_run_out2; %%% run_out2 = sum of running outcomes (pos/neg)
...
placebo.regression.day1 = mean(results.log_reg.day1.all_run_out2(drug==0,:));
placebo.regression.day2 = mean(results.log_reg.day2.all_run_out2(drug==0,:));
ssri.regression.day1 = mean(results.log_reg.day1.all_run_out2(drug==1,:));
ssri.regression.day2 = mean(results.log_reg.day2.all_run_out2(drug==1,:));
% regression weights ssri vs. placebo
[q p] = ttest2(results.log_reg.day1.all_run_out2(drug==1,:),results.log_reg.day1.all_run_out2(drug==0,:));
[q p] = ttest2(results.log_reg.day2.all_run_out2(drug==1,:),results.log_reg.day2.all_run_out2(drug==0,:));
